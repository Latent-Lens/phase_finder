  ...
  build: {
    rollupOptions: {
      ...
      input: {
        ...
        djfModelValidation: path.resolve(__dirname, "help/djf-model-validation.html"),
        toolValidation: path.resolve(__dirname, "help/tool_validation.html"),
        resultValidation: path.resolve(__dirname, "help/result_validation.html"),
      },
    },
  },
});
